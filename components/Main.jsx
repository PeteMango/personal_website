...
import { AiOutlineClose, AiOutlineMenu, AiFillMail, AiFillInstagram} from "react-icons/ai";
      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-4 text-gray-700 ">
            Hey! I'm <span className="text-[#5651e5]">Peter</span>
          </h1>
          <h2 className="py-2 tet-gray-700">Aspiring Full Stack Developer</h2>
          <p className="py-4 text-gray-600 max-w-[60%] m-auto text-justify leading-7">
            You might know me as PeteMango. I am passionate about anything and
            ...
            Fuels Team (UWAFT) competiing in the EcoCar Challenge.
          </p>
